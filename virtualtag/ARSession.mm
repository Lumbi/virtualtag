...
namespace {
    ...
    NSString * AR_SESSION_ERROR_DOMAIN = @"vuforia_sample_application";
}
...
- (NSError *) NSErrorWithCode:(int) code {
    return [NSError errorWithDomain:AR_SESSION_ERROR_DOMAIN code:code userInfo:nil];
}
...
- (NSError *) NSErrorWithCode:(NSString *) description code:(NSInteger)code{
    ...
    return [NSError errorWithDomain:AR_SESSION_ERROR_DOMAIN
                               code:code
                           userInfo:userInfo];
}
...
- (void)initQCARInBackground
{
    ...
    @autoreleasepool {
        QCAR::setInitParameters(mQCARInitFlags,"f26cdc2e0d4f4ea5a82b15c68ea18317");
...
{
    return [self.delegate imageToRender];
}
...
- (void) errorMessage:(NSString *) message {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:AR_SESSION_ERROR_DOMAIN
                                                    message:message
                                                   delegate:nil
